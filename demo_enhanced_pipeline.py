...
def demo_single_pdf(pdf_path: str, threshold: float = 0.35):
    ...
    print(f"🚀 Concept Database: {len(concept_database)} boost concepts loaded")
...
def demo_concept_extraction(text_sample: str, threshold: float = 0.35):
    ...
    boosted_concepts = [c for c in concepts if c.get('method') == 'database_boosted']
...
def main():
    ...
    print("   - Adding domain-specific terms to your concept_database.json")
