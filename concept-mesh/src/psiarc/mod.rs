//! PsiArc Module
//!
//! This module provides functionality for working with PsiArc files,
//! which are used to store ConceptDiffs for later replay. It also includes
//! metadata handling to enable better organization and searchability.
...
impl PsiarcManager {
    ...
    pub fn create_psiarc(
        ...
        let filename = if name.is_empty() {
            format!("ψ-{}.psiarc", chrono::Utc::now().format("%Y-%m-%dT%H:%M:%S"))
        } else {
