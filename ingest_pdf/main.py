...
# ===================================================================
# ENHANCED EXTRACTION ENDPOINT (MULTI-TENANT AWARE)
# ===================================================================
...
async def search_concepts_fallback(query: str) -> list:
    ...
    # Simple keyword database for anonymous users
    concept_database = {
    ...
    for keyword, concepts in concept_database.items():
...
async def health():
    ...
    return {
        ...
        "system_stats": multi_tenant_manager.get_system_stats()
    }
